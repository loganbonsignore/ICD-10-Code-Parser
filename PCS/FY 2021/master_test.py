...
###########################################################################################################################
# The class definitions are taken from parse_index.py
# Update code fixes here
# To test live, comment all 'testing blocks' and uncomment code blocks that were commented out to test
# Only code blocks next to a testing block were commented out to test

# Testing Modifications:
    # All modifications are under a '### TESTING ###' line
        # Call this a 'testing block'
        # Search the document for "TESTING" to see where testing modifications have been made
    # Changed the code at:
        # All 'raise' statements
            # Always indicate failed test if error is raised for any mainterm
            # test_flag = False
        # All execute functions (functions that return information to the user) 
            # Comment code used to return information to the user (print statements, etc)
            # Create a TESTING block that checks for the information the function is expecting without returning it to the user
            # test_flag = True if expected information is present
            # test_flag = False is unexpected information found
        # Parser.execute_tree()
            # Use testing functions in place of single_level_parser.execute_single_level(mainterm) and self.progress_through_levels(mainterm)
        ...
        # Testing Functions
            # Used to point mainterm objets to their 
